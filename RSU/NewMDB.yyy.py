...
class NewMDB:
    ...
    def ADDTo_SurveyUsed(self, SurveyTitle):
        query ="insert INTO Results_SurveyUsed(AnalysisKey,SurveyTitle) "
        query+="Values("
        query+=str(self.AnalysisKey.GetValue())
        query+=",'"
        query+=SurveyTitle
    ...
    def ADDTo_TranChar(self, SurveyTitle,Location,SiteNum,Year,StatArea,SubArea,InBed,NumTran,\
                       TransectArea,SurveyedQuadCount):
        query ="insert INTO Results_TranChar(AnalysisKey,TranCharKey,SurveyTitle,Location,SiteNum,Yr,StatArea,SubArea,InBed,"
        query+="NumTran,TransectArea,SurveyedQuadCount) "
        query+="Values("
        query+=str(self.AnalysisKey.GetValue())
        query+=","
    ...
    def GetTranCharKey(self,SurveyTitle,Location,SiteNum,Year,StatArea,SubArea,InBed):
        ...
        try:
            ...
            print('\nNewMDB 313')
            print('[SurveyTitle,Location,SubSampleLocation,Yr,StatArea,SubArea,InBed]',[SurveyTitle,Location,SiteNum,Year,StatArea,SubArea,InBed])
